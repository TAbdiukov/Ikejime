...
if __name__ == '__main__':
	...
	if(resp == False):
		...
		obj = binpatcher.Patcher(gen_patchstring(patch_1_1_old, patch_1_1_new))
		obj.payload()
		
		obj = binpatcher.Patcher(gen_patchstring(patch_1_2_old, patch_1_2_new))
		obj.payload()

		obj = binpatcher.Patcher(gen_patchstring(patch_2_old, patch_2_new))
		obj.payload()

		obj = binpatcher.Patcher(gen_patchstring(patch_3_1_old, patch_3_1_new))
		obj.payload()

		obj = binpatcher.Patcher(gen_patchstring(patch_3_2_old, patch_3_2_new))
		obj.payload()
		print("Done.")
